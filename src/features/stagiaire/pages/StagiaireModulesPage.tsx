...
const mockModules = [
  { code: 'M101', nom: 'Bases de Donnees', vol: '90h', formateur: 'Mohammed Alaoui', progression: 65 },
  { code: 'M101', nom: 'Bases de Donnees', vol: '90h', formateur: 'Mohammed Alaoui', progression: 65 },
  { code: 'M101', nom: 'Bases de Donnees', vol: '90h', formateur: 'Mohammed Alaoui', progression: 55 },
  { code: 'M101', nom: 'Bases de Donnees', vol: '90h', formateur: 'Mohammed Alaoui', progression: 40 },
  { code: 'M101', nom: 'Bases de Donnees', vol: '90h', formateur: 'Mohammed Alaoui', progression: 40 },
  { code: 'M101', nom: 'Bases de Donnees', vol: '90h', formateur: 'Mohammed Alaoui', progression: 40 },
  { code: 'M101', nom: 'Bases de Donnees', vol: '90h', formateur: 'Mohammed Alaoui', progression: 55 },
];
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50/50 border-y border-gray-100">
                ...
                {['Code Module', 'Nom', 'Vol. Horaire', 'Formateur', 'Progression'].map(col => (
            ...
            <tbody className="divide-y divide-gray-50">
              {mockModules.map((mod, i) => (
                <tr key={i} className="hover:bg-gray-50/50">
                  ...
                  <td className="px-4 py-3.5 text-sm text-gray-600">{mod.formateur}</td>
                  <td className="px-4 py-3.5">
