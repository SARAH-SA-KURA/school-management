...
import SurveillantDashboardPage from '../features/surveillant/pages/SurveillantDashboardPage';
import SurveillantStagiairesPage from '../features/surveillant/pages/SurveillantStagiairesPage';
import SurveillantFormateursPage from '../features/surveillant/pages/SurveillantFormateursPage';
import SurveillantGroupesPage from '../features/surveillant/pages/SurveillantGroupesPage';
import SurveillantSallesPage from '../features/surveillant/pages/SurveillantSallesPage';
...
const router = createBrowserRouter([
  ...
  // Surveillant routes
  {
    ...
    children: [
      { path: '/surveillant/dashboard', element: <SurveillantDashboardPage /> },
      { path: '/surveillant/stagiaires', element: <SurveillantStagiairesPage /> },
      { path: '/surveillant/formateurs', element: <SurveillantFormateursPage /> },
      { path: '/surveillant/groupes', element: <SurveillantGroupesPage /> },
      { path: '/surveillant/salles', element: <SurveillantSallesPage /> },
      { path: '/surveillant/modules', element: <SurveillantModulesPage /> },
      { path: '/surveillant/filieres', element: <SurveillantFilieresPage /> },
